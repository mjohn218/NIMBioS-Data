...
perioddiff = period - [0; period(1:length(period)-1)];
period = sum(perioddiff)/length(perioddiff);
annotation('textbox',[.83 .825 .1 .1],'String',strcat('Period: ', num2str(period)),'LineStyle','none');
...
perioddiff = period - [0; period(1:length(period)-1)];
period = sum(perioddiff)/length(perioddiff);
annotation('textbox',[.83 .35 .1 .1],'String',strcat('Period: ', num2str(period)),'LineStyle','none');
