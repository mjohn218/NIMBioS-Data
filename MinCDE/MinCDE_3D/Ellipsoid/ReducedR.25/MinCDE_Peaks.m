...
annotation('textbox',[.21 .825 .1 .1],'String',strcat('Period: ', num2str(period),' s'),'LineStyle','none');
...
axis([0 1200 -0.0025 0.0025]);
% Period calculation
[PNumPks, PPksInd] = findPeaks(ESymVal, time);
period = time(PPksInd);
perioddiff = period - [0; period(1:length(period)-1)];
period = sum(perioddiff)/length(perioddiff);
annotation('textbox',[.635 .825 .1 .1],'String',strcat('Period: ', num2str(period),' s'),'LineStyle','none');
...
perioddiff = period - [0; period(1:length(period)-1)];
period = sum(perioddiff)/length(perioddiff);
annotation('textbox',[.21 .35 .1 .1],'String',strcat('Period: ', num2str(period),' s'),'LineStyle','none');
...
perioddiff = period - [0; period(1:length(period)-1)];
period = sum(perioddiff)/length(perioddiff);
annotation('textbox',[.635 .35 .1 .1],'String',strcat('Period: ', num2str(period),' s'),'LineStyle','none');
...
perioddiff = period - [0; period(1:length(period)-1)];
period = sum(perioddiff)/length(perioddiff);
annotation('textbox',[.83 .35 .1 .1],'String',strcat('Period: ', num2str(period),' s'),'LineStyle','none');
