...
eq = [rsum(ODEerr(find(ODE(:,1)>=5e1,1,'first'):find(ODE(:,1)<=1e2,1,'last')),...
    ODE(find(ODE(:,1)>=5e1,1,'first'):find(ODE(:,1)<=1e2,1,'last'),1));...
    rsum(Gillespieerr(find(Gillespie(:,1)>=5e1,1,'first'):find(Gillespie(:,1)<=1e2,1,'last')),...
    Gillespie(find(Gillespie(:,1)>=5e1,1,'first'):find(Gillespie(:,1)<=1e2,1,'last'),1));...
    rsum(PDEerr(find(PDE(:,1)>=5e1,1,'first'):find(PDE(:,1)<=1e2,1,'last')),...
    PDE(find(PDE(:,1)>=5e1,1,'first'):find(PDE(:,1)<=1e2,1,'last'),1));...
    rsum(Smoldynerr(find(Smoldyn(:,1)>=5e1,1,'first'):find(Smoldyn(:,1)<=1e2,1,'last')),...
    Smoldyn(find(Smoldyn(:,1)>=5e1,1,'first'):find(Smoldyn(:,1)<=1e2,1,'last'),1));...
    rsum(MCellerr(find(MCell(:,1)>=5e1,1,'first'):find(MCell(:,1)<=1e2,1,'last')),...
    MCell(find(MCell(:,1)>=5e1,1,'first'):find(MCell(:,1)<=1e2,1,'last'),1));...
    rsum(FPRerr(find(FPR(:,1)>=5e1,1,'first'):find(FPR(:,1)<=1e2,1,'last')),...
    FPR(find(FPR(:,1)>=5e1,1,'first'):find(FPR(:,1)<=1e2,1,'last'),1))];
